...
import com.example.ordermadeeasy.adapters.PlaceOrderAdapter;
...
public class YourCartActivity extends Fragment implements CartListAdapter.EventListener{
        ...
        call.enqueue(new Callback<JsonElement>() {
            ...
            public void onResponse(Call<JsonElement> call, Response<JsonElement> response) {
                ...
                if(response.body()!=null){
                    ...
                    else Toast.makeText(cartContext, "Exception",Toast.LENGTH_SHORT).show();
    ...
    public void onDelete(Boolean data) {
        ...
        //tv_items_in_cart.setText(cartSize);

...
import com.example.ordermadeeasy.adapters.SupplierConsumerOrderHistoryUpdateAdapter;
...
public class SupplierConsumerOrderHistoryUpdateActivity extends Fragment  {
    ...
    SupplierConsumerOrderHistoryUpdateAdapter adapter;
    String po_id;
    String status;
    ...
    public static SupplierConsumerOrderHistoryUpdateActivity newInstance() {
        Bundle args = new Bundle();
        SupplierConsumerOrderHistoryUpdateActivity fragment = new SupplierConsumerOrderHistoryUpdateActivity();
            ...
            public void onResponse(Call<OrderStatusMainObject> call, Response<OrderStatusMainObject> response) {
                ...
                if(response.body()!=null){
                    ...
                    if(response.body().getInfo().getErrorCode()==0) {
                        ...
                        adapter = new SupplierConsumerOrderHistoryUpdateAdapter(getActivity(), context, statusList, productList, userType);
    ...
    public void showLoaderNew() {
        mActivity.runOnUiThread(new SupplierConsumerOrderHistoryUpdateActivity.Runloader(getResources().getString(R.string.loading)));
    }

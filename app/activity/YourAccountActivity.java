...
import com.example.ordermadeeasy.adapters.CityListAdapter;
import com.example.ordermadeeasy.adapters.StateListAdapter;
import com.example.ordermadeeasy.api_interface.CityListDataInterface;
import com.example.ordermadeeasy.api_interface.EditProfileDataInterface;
import com.example.ordermadeeasy.api_interface.MyProfileDataInterface;
import com.example.ordermadeeasy.api_interface.StateListDataInterface;
import com.example.ordermadeeasy.app.Constants;
import com.example.ordermadeeasy.object_models.CityListMainObject;
import com.example.ordermadeeasy.object_models.CityNamesObject;
...
import com.example.ordermadeeasy.object_models.StateListResultObject;
...
public class YourAccountActivity extends Fragment {
   public Dialog dialog;
    ...
    public static YourAccountActivity newInstance() {

        Bundle args = new Bundle();

        YourAccountActivity fragment = new YourAccountActivity();
    ...
    private void serviceCallforGettingCityList(){
       ...
       // Call<CityListMainObject> call = service.getStringScalar(Integer.parseInt(retailerId), new GetCityPostParameters(String.valueOf(stateId)));
        Call<CityListMainObject> call = service.getStringScalar(Integer.parseInt(userId), new GetCityPostParameters(String.valueOf(stateId)));

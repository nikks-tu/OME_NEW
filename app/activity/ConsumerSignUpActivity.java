...
import com.example.ordermadeeasy.api_interface.CustomerRegisterDataInterface;
...
import com.example.ordermadeeasy.utilities.ClickToSelectEditText;
...
public class ConsumerSignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spin_state.setOnItemSelectedListener((item, selectedIndex) -> {
            if(stateList.size()>0)
            {
                //Toast.makeText(context, stateList.get(selectedIndex).getStateName(), Toast.LENGTH_SHORT).show();

...
import com.techuva.ome_new.adapters.SupplierConsumerOrdersHistoryAdapter;
            ...
            public void onResponse(Call<SupplierConsumerHistoryMainObject> call, Response<SupplierConsumerHistoryMainObject> response) {
                ...
                if(response.body()!=null){
                    if(response.body().getInfo().getErrorCode()==0)
                    {
                        ...
                        {
                            SupplierConsumerHistoryResultObject object = new SupplierConsumerHistoryResultObject();
                            object.setOrderStatus(response.body().getResult().get(i).getOrderStatus());
                            object.setOrderedOn(response.body().getResult().get(i).getOrderedOn());
                            object.setPoId(response.body().getResult().get(i).getPoId());
                            object.setAddress1(response.body().getResult().get(i).getAddress1());
                            object.setCompanyName(response.body().getResult().get(i).getCompanyName());
                            object.setAddress2(response.body().getResult().get(i).getAddress2());
                            object.setMobileNo(response.body().getResult().get(i).getMobileNo());
                            object.setOrderByName(response.body().getResult().get(i).getOrderByName());

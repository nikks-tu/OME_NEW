...
import com.techuva.ome_new.api_interface.ChangePasswordDataInterface;
...
public class ChangePassword extends Fragment {
    ...
    public void showLoaderNew() {
        mActivity.runOnUiThread(new ChangePassword.Runloader(getResources().getString(R.string.loading)));
    }

...
import com.techuva.ome_new.adapters.SupplierConsumerOrderUpdateAdapter;
...
public class SupplierConsumerOrderUpdateActivity extends Fragment {
    ...
    public static SupplierConsumerOrderUpdateActivity newInstance() {
        Bundle args = new Bundle();
        SupplierConsumerOrderUpdateActivity fragment = new SupplierConsumerOrderUpdateActivity();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        tv_accept.setOnClickListener(v -> {
            boolean isAnyOrderSelected = false;
            productList = new ArrayList<>();
           ...
           if(isAnyOrderSelected)
           {
               ...
               Toast.makeText(context,"Please select orders to update!",Toast.LENGTH_SHORT).show();
           }
        });
                ...
                if(response.body()!=null){
                    ...
                    if(response.body().getInfo().getErrorCode()==0) {
                        ...
                        new Handler().postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                if (productList.get(0).getStatusShortCode().equals("PEN"))
                                {
                        ...
                        adapter = new SupplierConsumerOrderUpdateAdapter(getActivity(), context, statusList, productList, userType);
    ...
    public void showLoaderNew() {
        mActivity.runOnUiThread(new SupplierConsumerOrderUpdateActivity.Runloader(getResources().getString(R.string.loading)));
    }

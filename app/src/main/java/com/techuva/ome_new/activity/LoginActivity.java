...
import com.techuva.ome_new.api_interface.DeviceTokenDataInterface;
...
public class LoginActivity extends AppCompatActivity {
                ...
                if(response.body()!=null){
                    ...
                    if(errorCode==0)
                    {
                        ...
                        {  Toast.makeText(loginContext, "Login not allowed, Please login to our website!", Toast.LENGTH_LONG).show();
                            ...
                            String token  = MApplication.getString(loginContext, Constants.Device_Token);
    ...
    private void InitViews() {
        ...
        FirebaseApp.initializeApp(loginContext);
        FirebaseInstanceId.getInstance().getInstanceId().addOnCompleteListener(task -> {
            ...
            MApplication.setString(loginContext, Constants.Device_Token, token);
            // Log and toast
    ...
    private void serviceCallForSavingToken(String token){
        ...
        authorityKey = "Bearer "+MApplication.getString(loginContext, Constants.AccessToken);

...
import com.techuva.ome_new.adapters.AllOrdersListAdapter;
import com.techuva.ome_new.adapters.ConsumerOrdersAdapter;
import com.techuva.ome_new.adapters.DealersFilterAdapter;
import com.techuva.ome_new.adapters.OrderStatusFilterAdapter;
...
import com.techuva.ome_new.object_models.ConsumerAllOrderObject;
...
import com.techuva.ome_new.object_models.ShopperOrdersResultObject;
        ...
        scrollListener = new EndlessScrollListener() {
            ...
            public boolean onLoadMore(int page, int totalItemsCount) {
                if (pageNumber < listCount) {
                   ...
                   // Toast.makeText(context, "Scroll" + pageNumber+ " "+listCount, Toast.LENGTH_SHORT).show();
            ...
            public void onResponse(Call<OrderStatusMainObject> call, Response<OrderStatusMainObject> response) {
                ...
                if(response.body()!=null){
                    ...
                    if(response.body().getInfo().getErrorCode()==0)
                    {
                        ...
                        orderStatusAdapter = new OrderStatusFilterAdapter(mActivity, R.layout.item_order_status, R.id.tv_status_name, statusList);

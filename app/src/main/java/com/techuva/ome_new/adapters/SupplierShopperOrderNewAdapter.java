...
import com.techuva.ome_new.holders.SupplierShopperOrdersHolder;
...
public class SupplierShopperOrderNewAdapter extends RecyclerView.Adapter<SupplierShopperOrdersHolder> {
    ...
    public SupplierShopperOrderNewAdapter(Activity activity, Context context, ArrayList<SupplierShopperOrderResultObject> arrayList, EventListener listener) {

...
import com.techuva.ome_new.holders.SearchCompanyRCVHolder;
...
public class SearchCompanyAdapter extends RecyclerView.Adapter<SearchCompanyRCVHolder> {// Recyclerview will extend to
    ...
    int tempCartSize;
    public SearchCompanyAdapter(Context context, Activity activity, ArrayList<CompanyListObjectModel> arrayList, EventListener listener) {

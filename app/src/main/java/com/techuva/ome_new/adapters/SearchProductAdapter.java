...
import com.techuva.ome_new.activity.ProductDescFragment;
import com.techuva.ome_new.app.Constants;
import com.techuva.ome_new.domain.PlaceOrderDO;
import com.techuva.ome_new.holders.SearchProductRCVHolder;
import com.techuva.ome_new.object_models.GetDealerResultObject;
import com.techuva.ome_new.object_models.ProductStatusLineObject;
...
public class SearchProductAdapter extends RecyclerView.Adapter<SearchProductRCVHolder> {// Recyclerview will extend to
    ...
    public SearchProductAdapter(Context context, Activity activity, ArrayList<SearchProductResultObject> arrayList, EventListener listener) {

...
{   // Recyclerview will extend to
    ...
    public AllOrdersListAdapter(Activity activity, Context context, ArrayList<OrderStatusResultObject> statusList, ArrayList<ShopperOrdersResultObject> arrayList, OnItemClicked listener, EventListener eventListener) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       View view = null;
        ...
        if(model.getStatusId()==2)
        {
            ...
            holder.tv_order_date.setText(model.getReceivedOn());

...
public class ConsumerOrderUpdateAdapter extends BaseAdapter
{
    ...
    public ConsumerOrderUpdateAdapter(Activity activity, Context context, ArrayList<OrderStatusResultObject> statusList, ArrayList<SupplierConsumerOrderProduct> arrayList, String userType) {

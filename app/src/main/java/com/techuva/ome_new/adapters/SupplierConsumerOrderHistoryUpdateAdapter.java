...
public class SupplierConsumerOrderHistoryUpdateAdapter extends BaseAdapter
{
    ...
    public SupplierConsumerOrderHistoryUpdateAdapter(Activity activity, Context context, ArrayList<OrderStatusResultObject> statusList, ArrayList<SupplierConsumerOrderProduct> arrayList, String userType) {

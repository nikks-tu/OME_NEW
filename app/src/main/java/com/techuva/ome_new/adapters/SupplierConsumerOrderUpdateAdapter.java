...
public class SupplierConsumerOrderUpdateAdapter extends BaseAdapter
{
    ...
    public SupplierConsumerOrderUpdateAdapter(Activity activity, Context context, ArrayList<OrderStatusResultObject> statusList, ArrayList<SupplierConsumerOrderProduct> arrayList, String userType) {

...
import com.example.ordermadeeasy.holders.CartListRCVHolder;
...
public class CartListAdapter extends RecyclerView.Adapter<CartListRCVHolder> {// Recyclerview will extend to
    ...
    public CartListAdapter(AppCompatActivity activity, Context context, ArrayList<GetDealerResultObject> dealersList, ArrayList<PlaceOrderDO> arrayList, EventListener listener) {

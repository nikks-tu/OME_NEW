...
public class ConsumerOrderUpdateAdapter extends BaseAdapter
{
    ...
    public ConsumerOrderUpdateAdapter(AppCompatActivity activity, Context context, ArrayList<OrderStatusResultObject> statusList, ArrayList<SupplierConsumerOrderProduct> arrayList, String userType) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ConsumerOrderUpdateAdapter.ViewHolder holder = null;
        View view = null;
        ...
        holder = new ConsumerOrderUpdateAdapter.ViewHolder();
       ...
       if(model.getProductImage()!=null)
       {
        ...
        holder.txt_order_status.setOnClickListener(v -> {
            ...
            if(finalHolder.txt_order_status.getTag().toString().equalsIgnoreCase("8"))
            {
                ...
                {
                    if(statusList.get(i).getStatusId()==15)
                    {
        ...
        menu.setOnMenuItemClickListener(item -> {
            ...
            else
            {
                ...
                if(id==15)
                {
                   ...
                   jsonObject.addProperty("order_id", arrayList.get(position).getOrderId());
    ...
    private void serviceCallforCancelOrder(JsonObject jsonObject) {
        ...
        int demanid = arrayList.get(pos).getOrderId();
        Call<JsonElement> call = service.cancelConsumerOrder(userId ,accessToken,  jsonObject);
            ...
            public void onResponse(Call<JsonElement> call, Response<JsonElement> response) {
                ...
                if (response.body() != null) {
                 ...
                 if (errorCode==0)
                 {
                     ...
                     MApplication.serviceCallforConsumerPendingOrders(context, accessToken, String.valueOf(userId), userType);
                 }
                 else {
                     Toast.makeText(context,errorMsg,Toast.LENGTH_SHORT).show();
                 }
    ...
    private void serviceCallforUpdateOrder(JsonObject jsonObject) {
        ...
        UpdateOrderDataInterface service = retrofit.create(UpdateOrderDataInterface.class);
        Call<JsonElement> call = service.updateConsumerOrder(userId ,accessToken, jsonObject);
        call.enqueue(new Callback<JsonElement>() {
            @Override
            public void onResponse(Call<JsonElement> call, Response<JsonElement> response) {
                dialog.dismiss();

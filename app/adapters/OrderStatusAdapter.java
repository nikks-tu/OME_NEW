...
public class OrderStatusAdapter extends ArrayAdapter<OrderStatusResultObject> {

    private int selectedPosition = -1;
    LayoutInflater flater;
    List<OrderStatusResultObject> list;

    public OrderStatusAdapter(AppCompatActivity context, int resouceId, int textviewId, List<OrderStatusResultObject> list){

...
{   // Recyclerview will extend to
    ...
    public ConsumerOrdersAdapter(AppCompatActivity activity, Context context, ArrayList<ConsumerAllOrderResultObject> arrayList, OnItemClicked listener, EventListener eventListener, String userType) {

...
public class SupplierConsumerOrderHistoryUpdateAdapter extends BaseAdapter
{
    ...
    public SupplierConsumerOrderHistoryUpdateAdapter(AppCompatActivity activity, Context context, ArrayList<OrderStatusResultObject> statusList, ArrayList<SupplierConsumerOrderProduct> arrayList, String userType) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        SupplierConsumerOrderHistoryUpdateAdapter.ViewHolder holder = null;
        View view = null;
        ...
        holder = new SupplierConsumerOrderHistoryUpdateAdapter.ViewHolder();
